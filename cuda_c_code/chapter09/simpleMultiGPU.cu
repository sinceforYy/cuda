...
/*
* a multi-GPU CUDA application implementing a vector sum.
*/
...
int main(int argc, char **argv)
{
    ...
    if (argc > 1)
    {
        ...
        {
            fprintf(stderr, "Invalid number of GPUs specified: %d is greater than"
                   "the total number of GPUs in this platform(%d)\n",atoi(argv[1]),ngpus);
            exit(1);
        }
